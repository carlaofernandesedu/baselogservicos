...
namespace Prodesp.Log.Common
{
    ...
    public class FormatUtils
    {
        ...
        public static string FormatTraceApi(string componentName, string method, TimeSpan timespan, string properties)
        {
            return String.Concat("Component:", componentName, ";Method:", method, ";Timespan:", timespan.ToString(), ";Properties:", properties);
        }
        ...
        public static string FormatExceptionStackTrace(Exception exception)
        {
            if (exception == null)
                return String.Empty;
            var sb = new StringBuilder();
